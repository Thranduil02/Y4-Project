...
def update(val):
    ...
    axes["A"].clear()
    axes["A"].plot(np.log(r),np.log(phidash_planar(r, r_0, beta, rho, M_p)), label='$L_2$', color='red')
    ...
    axes["B"].clear()
    axes["B"].plot(np.log(r), np.log(phidash_spherical_l2(r, r_0, beta, rho, M_p)), 'r', label='$L_2$')
    axes["B"].plot(np.log(r), np.log(phidash_spherical_l3(r, Lambda, r_0, r_v_spherical)), 'b',label='$L_2+L_3$')
    axes["B"].plot(np.log(r), np.log(phidash_spherical_l4(r, Lambda, beta, rho, r_0)),'g', label='$L_2+L_3+L_4$')
    axes["B"].set_xlabel('$\log(r)$', fontsize=14)
    axes["B"].set_ylabel("$\phi'$", fontsize=14)
    axes["B"].set_title('Spherical Source')
    axes["B"].legend()

    axes["C"].clear()
    axes["C"].plot(np.log(r), np.log(phidash_cylindrical_l2(r, r_0, beta, rho, M_p)), 'r', label='$L_2$')
    axes["C"].plot(np.log(r), np.log(phidash_cylindrical_l3(r, Lambda, r_0 ,r_v_cylindrical)), label='$L_2+L_3$')
...
axes["A"].plot(np.log(r),np.log(phidash_planar(r, r_0, beta, rho, M_p)), label='$L_2$', color='red')
axes["A"].set_xlabel('$\log(r)$', fontsize=14)
axes["A"].set_ylabel("$\log(\phi')$", fontsize=14)
axes["A"].set_title('Planar Source')
axes["A"].legend()
...
axes["B"].plot(np.log(r), np.log(phidash_spherical_l4(r, Lambda, beta, rho, r_0)),'g', label='$L_2+L_3+L_4$')
axes["B"].set_xlabel('$\log(r)$', fontsize=14)
axes["B"].set_ylabel("$\log(\phi')$", fontsize=14)
axes["B"].set_title('Spherical Source')
axes["B"].legend()

axes["C"].plot(np.log(r), np.log(phidash_cylindrical_l2(r, r_0, beta, rho, M_p)), 'r', label='$L_2$')
axes["C"].plot(np.log(r), np.log(phidash_cylindrical_l3(r, Lambda, r_0 ,r_v_cylindrical)),'b', label='$L_2+L_3$')
axes["C"].set_xlabel('$\log(r)$', fontsize=14)
axes["C"].set_ylabel("$\log(\phi')$", fontsize=14)
axes["C"].set_title('Cylindrical Source')
axes["C"].legend()
